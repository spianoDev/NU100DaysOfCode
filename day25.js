...
// Your task is to shorten the code as much as possible. Note that submitting the given code will not work because there
...
/** Function **/
// original refactor passed all initial tests, but didn't pass the kata
...
function describeAge(age) {return "You're a(n) "+(age<=12?"kid":age<=17?"teenager":age<=64?"adult":"elderly");}
// 111 total characters
